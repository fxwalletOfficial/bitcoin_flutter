...
import 'package:bitcoin_flutter/src/templates/pubkeyhash.dart' as p2pkh;
import 'package:bitcoin_flutter/src/templates/witnesspubkeyhash.dart' as p2wpkh;
...
bool inputCheck(List<dynamic> chunks, bool allowIncomplete) {
  ...
  // is witness?
  if (chunks.length == 1) return p2wpkh.outputCheck(bscript.compile(redeemScriptChunks)!);
  if (p2pkh.inputCheck(scriptSigChunks) && p2pkh.outputCheck(bscript.compile(redeemScriptChunks)!)) return true;
